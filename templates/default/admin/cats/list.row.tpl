<tr>
	...
	<td>
		<a onClick="return confirm('Вы уверены, что хотите удалить категорию <TVAR>cat_name</TVAR>?');" href="/admin.php?action=delete_cat&id=<TVAR>cat_id</TVAR>&show=cats"><img src="/templates/<SYS>template</SYS>/img/delete.gif" border="0"></a>
