<h2 class="title">Выбор и получение кода для сайта</h2>
	<form action="/account/sites/<TVAR>site_id</TVAR>/code.html" method="post">
		<table class="table" cellpadding="0" width="100%" cellspacing="5">
			...
			<tr><td colspan="2" align="right"><input type="submit" value="Получить код" class="btn btn-secondary"></td></tr>
		</table>
	</form>
		<h4>Код для установки на сайте</h4>
		<textarea class="form-control" style="width: 100%; height: 120px;"><TVAR>code</TVAR></textarea>
