<tr>
	...
	<td bgcolor="<TVAR>inf_row_color</TVAR>" align="center">
		...
		<a href="/account/informers/<TVAR>inf_id</TVAR>/delete.html"><img src="/templates/<SYS>template</SYS>/img/delete.gif" border="0"></a>
		<a href="/account/informers/<TVAR>inf_id</TVAR>/reports.html"><img src="/templates/<SYS>template</SYS>/img/reports.gif" border="0"></a>
	</td>
</tr>
